...
public enum LeaveError implements CommonError {
    ...
    INVALID_DATE_RANGE(HttpStatusCode.BAD_REQUEST, "40032", "휴가 종료일이 시작일보다 빠를 수 없습니다."),
    HALF_DAY_MUST_BE_SINGLE_DATE(HttpStatusCode.BAD_REQUEST, "40033", "반차는 단일 날짜만 신청 가능합니다."),
